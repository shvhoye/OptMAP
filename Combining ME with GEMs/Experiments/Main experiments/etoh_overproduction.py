# Combining evolutionary algorithms with genome scale modeling for intelligent metabolic engineering - EX_etoh_e overproduction
...
def ven_genes(performance_map, solution_map, model):
    ...
    for i in range(0, 11):
        for j in range(0, 5):
            if np.round(performance_map[i, j], 2) > threeBest[0]:
                ...
                threeBest_map[2] = threeBest_map[1]

                threeBest[1] = threeBest[0]
                threeBest_map[1] = threeBest_map[0]
    ...
    for k in range(0, 3):
        ...
        #print(sol_test.fluxes["BIOMASS_Ecoli_core_w_GAM"]*sol_test.fluxes["EX_etoh_e"])
...
def PhPP(original_model, solution, objective_ME):
    ...
    plt.plot(prod_env.flux_maximum,prod_env.EX_etoh_e, color = 'blue')

    plt.fill_between(prod_env.flux_maximum, prod_env.EX_etoh_e, np.min(prod_env.EX_etoh_e), facecolor='blue', alpha=0.1)
    ...
    plt.plot(prod_env.flux_maximum,prod_env.EX_etoh_e, color = 'green')

    plt.fill_between(prod_env.flux_maximum, prod_env.EX_etoh_e, np.min(prod_env.EX_etoh_e), facecolor='green', alpha=0.1)

    plt.ylabel('EX_etoh_e [mmol gDW^-1 h^-1]')
...
## EX_etoh_e overproduction

# MAP-Elites combined with the core E. coli GEM to maximize EX_etoh_e production.
...
print(sol1.fluxes["EX_etoh_e"])

print(sol1.fluxes["BIOMASS_Ecoli_core_w_GAM"]*sol1.fluxes["EX_etoh_e"])

# 2. Run MAP-Elites 

I1 = 100#5000 # Number of generations

MAP_Elites_model = core_e_coli_model.copy()

objective_ME = "EX_etoh_e"

MAP_solutions1, MAP_performances1, best_elite_per_generation = MAP_Elites(I1, MAP_Elites_model, objective_ME)

# np.save("Combining ME with GEMs/Results and Figures/MAP_solutions_EX_etoh__D_e5000", MAP_solutions1)

# np.save("Combining ME with GEMs/Results and Figures/MAP_performances_EX_etoh__D_e5000", MAP_performances1)

# np.save("Combining ME with GEMs/Results and Figures/best_elite_per_generation_EX_etoh__D_e5000", best_elite_per_generation)

succ_pef = np.load("Combining ME with GEMs/Results and Figures/MAP_performances_EX_etoh__D_e5000.npy")

succ_sol = np.load("Combining ME with GEMs/Results and Figures/MAP_solutions_EX_etoh__D_e5000.npy")
...
mapelites_heatmap(MAP_performances1[0:6],  values = False)
...
print(sol_best_elite.fluxes["EX_etoh_e"]) 

print(sol_best_elite.fluxes["BIOMASS_Ecoli_core_w_GAM"])

print(sol_best_elite.fluxes["BIOMASS_Ecoli_core_w_GAM"]*sol_best_elite.fluxes["EX_etoh_e"]) # = the performance
...
indices = np.where(best_elite == 1)[0] 
...
result = optgene.run(target=core_e_coli_model.reactions.EX_etoh_e,
...
df.to_csv (r'/Users/Shaun/Documents/School/2021 - 2022/Sem 2/a. Master thesis/Programming/Master Thesis/Combining ME with GEMs/Results and Figures/OptGene_results_etoh.csv', index = False, header=True)
...
data = {'Solution': ['1', '2', '3'], 'reactions': [('ATPS4r', 'NADH16', 'PGL', 'PPC', 'RPE', 'SUCOAS'), ('AKGDH', 'ATPS4r', 'G6PDH2r', 'NADH16'), ('NADH16', 'ATPS4r')], 'genes': [('b3732', 'b2286', 'b0767', 'b3956', 'b4301', 'b0728'), ('b0727', 'b3732', 'b1852', 'b2286'), ('b3734', 'b2286')], 'target_flux': ['15.51', '15.35', '14.20'], 'biomass_flux': ['0.19', '0.19', '0.20'], 'fitness': ['0.30', '0.30', '0.29']}

data2 = pd.DataFrame(data)

data2.to_csv (r'/Users/Shaun/Documents/School/2021 - 2022/Sem 2/a. Master thesis/Programming/Master Thesis/Combining ME with GEMs/Results and Figures/OptMAP_results_etoh.csv', index = False, header=True)
