...
MAP_Elites_model = iJR904.copy()

objective_ME = "GRTT" 

MAP_solutions1, MAP_performances1, best_elite_per_generation = MAP_Elites(I1, MAP_Elites_model, objective_ME)

np.save("Combining ME with GEMs/Results and Figures/MAP_solutions_GRTT_5000", MAP_solutions1)

np.save("Combining ME with GEMs/Results and Figures/MAP_performances_GRTT_5000", MAP_performances1)

np.save("Combining ME with GEMs/Results and Figures/best_elite_per_generation_GRTT_5000", best_elite_per_generation)
...
print(sol_best_elite.fluxes["GRTT"]) 

print(sol_best_elite.fluxes["BIOMASS_Ecoli"])

print(sol_best_elite.fluxes["BIOMASS_Ecoli"]*sol_best_elite.fluxes["GRTT"]) # = the performance
...
result = optgene.run(target=model1.reactions.UAGDP,
...
df.to_csv (r'/Users/Shaun/Documents/School/2021 - 2022/Sem 2/a. Master thesis/Programming/Master Thesis/Combining ME with GEMs/Results and Figures/OptGene_results_GRTT.csv', index = False, header=True)
