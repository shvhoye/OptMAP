...
#cobra.io.write_sbml_model(e_coli_flavanone, "e_coli_flavanone_from_iJR904.xml")

#---

# 4. Run MAP-Elites 

I1 = 5000 # Number of generations
...
result = optgene.run(target=e_coli_flavanone.reactions.NARGt,
                     biomass=e_coli_flavanone.reactions.BIOMASS_Ecoli,
                     substrate=e_coli_flavanone.metabolites.glc__D_e,
