...
# MAP-Elites combined with the iJR904 E. coli GEM to maximize succinate production.
...
print(sol1.fluxes["SUCCt2r"])

print(sol1.fluxes["BIOMASS_Ecoli"]*sol1.fluxes["EX_succ_e"])
...
objective_ME = "SUCCt2r" # SUCCt2r is the final reaction to get extracellular succinate: succ_c + h_e ⇌ h_c + succ_e
...
print(sol_best_elite.fluxes["BIOMASS_Ecoli"]*sol_best_elite.fluxes["SUCCt3"]) # = the performance
...
result = optgene.run(target=model1.reactions.SUCCt3,
                     biomass=model1.reactions.BIOMASS_Ecoli,
                     substrate=iJR904.medium,
