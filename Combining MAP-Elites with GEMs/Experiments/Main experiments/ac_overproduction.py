# Combining evolutionary algorithms with genome scale modeling for intelligent metabolic engineering - Acetate overproduction
...
def ven_genes(performance_map, solution_map, model):
    ...
    for k in range(0, 3):
        ...
        #print(sol_test.fluxes["BIOMASS_Ecoli_core_w_GAM"]*sol_test.fluxes["EX_ac_e"])
...
def PhPP(original_model, solution, objective_ME):
    ...
    plt.plot(prod_env.flux_maximum,prod_env.EX_ac_e, color = 'blue')

    plt.fill_between(prod_env.flux_maximum, prod_env.EX_ac_e, np.min(prod_env.EX_ac_e), facecolor='blue', alpha=0.1)
    ...
    plt.plot(prod_env.flux_maximum,prod_env.EX_ac_e, color = 'green')

    plt.fill_between(prod_env.flux_maximum, prod_env.EX_ac_e, np.min(prod_env.EX_ac_e), facecolor='green', alpha=0.1)

    plt.ylabel('EX_ac_e [mmol gDW^-1 h^-1]')
...
## Acetate overproduction

# MAP-Elites combined with the core E. coli GEM to maximize acetate production.
...
print(sol1.fluxes["EX_ac_e"])

print(sol1.fluxes["BIOMASS_Ecoli_core_w_GAM"]*sol1.fluxes["EX_ac_e"])

# 2. Run MAP-Elites 

I1 = 100#15000 # Number of generations

MAP_Elites_model = core_e_coli_model.copy()

objective_ME = "EX_ac_e"

MAP_solutions1, MAP_performances1, best_elite_per_generation = MAP_Elites(I1, MAP_Elites_model, objective_ME)

# np.save("Combining ME with GEMs/Results and Figures/MAP_solutions_ac5000", MAP_solutions1)

# np.save("Combining ME with GEMs/Results and Figures/MAP_performances_ac5000", MAP_performances1)

# np.save("Combining ME with GEMs/Results and Figures/best_elite_per_generation_ac5000", best_elite_per_generation)

succ_pef = np.load("Combining ME with GEMs/Results and Figures/MAP_performances_ac5000.npy")

succ_sol = np.load("Combining ME with GEMs/Results and Figures/MAP_solutions_ac5000.npy")
...
print(sol_best_elite.fluxes["EX_ac_e"]) 

print(sol_best_elite.fluxes["BIOMASS_Ecoli_core_w_GAM"])

print(sol_best_elite.fluxes["BIOMASS_Ecoli_core_w_GAM"]*sol_best_elite.fluxes["EX_ac_e"]) # = the performance
...
result = optgene.run(target=core_e_coli_model.reactions.EX_ac_e,
...
df.to_csv (r'/Users/Shaun/Documents/School/2021 - 2022/Sem 2/a. Master thesis/Programming/Master Thesis/Combining ME with GEMs/Results and Figures/OptGene_results_ac2.csv', index = False, header=True)
...
data = {'Solution': ['1', '2', '3'], 'reactions': [('GND', 'ICL', 'SUCOAS'), ('ATPS4r'), ('ACALDt', 'CO2t', 'H2Ot', 'NH4t', 'O2t')], 'genes': [('b2029', 'b4015', 'b0728'), ('b3734'), ('s0001')], 'target_flux': ['10.62', '14.31', '8.32'], 'biomass_flux': ['0.62', '0.37', '0.21'], 'fitness': ['0.66', '0.54', '0.18']}

data2 = pd.DataFrame(data)

data2.to_csv (r'/Users/Shaun/Documents/School/2021 - 2022/Sem 2/a. Master thesis/Programming/Master Thesis/Combining ME with GEMs/Results and Figures/OptMAP_results_ac.csv', index = False, header=True)
